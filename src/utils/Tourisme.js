...
function Tourisme() {
  return (
    ...
    <div className="App">
      ...
      <p style={{
      ...
      }}>Nous mettons à votre disposition des guides touristiques pour vous permettre d'explorer sereinement les différents sites disponibles  et que vous souhaiterez visiter </p>
        ...
        <MediaQuery minWidth={1024} maxWidth={1919}>
          ...
          <Link to='https://wa.me/+2299632706' style={{
            textDecoration: 'none'
          }}>
            <div id="my_guide">
                <p className='guide_contactor'>CONTACTER UN GUIDE</p>
        ...
        <MediaQuery minWidth={0} maxWidth={1023}>
          ...
          <Link to='https://wa.me/+2299632706' className='lien'>
              <div>
                <p className='guidy' 
